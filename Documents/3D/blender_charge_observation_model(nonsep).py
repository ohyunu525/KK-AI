...
SHOW_CHARGE_SYMBOLS = False       # nonsep: do not create + / - meshes
...
# nonsep version: both positive and negative charge spheres are black.
# The white +/- mesh markers remain visible for readability.
COLOR_CHARGE_BLACK = (0.01, 0.01, 0.01, 1.0)
COLOR_POSITIVE = COLOR_CHARGE_BLACK
COLOR_NEGATIVE = COLOR_CHARGE_BLACK
...
def create_charge(
    ...
    if SHOW_CHARGE_SYMBOLS:
        # Put the sign slightly above the visible sphere surface, facing the
        # same default presentation viewpoint as the axis labels.
        ...
        # Parenting keeps the sign attached if the user moves/rotates charge.
        symbol.parent = obj
