...
Creates a fully editable V(x, y) surface calculated on the physical z=0 plane.
...
FIELD_MODE = 'V'                 # This file visualizes signed potential V
VERTICAL_AXIS_LABEL = "V"
EPSILON_0 = 1.0
POTENTIAL_GRID_SIZE = 32
SURFACE_DISPLAY_HEIGHT = 2.25    # Visual height; actual V values remain in tick labels
...
AUTO_EXPORT = False
EXPORT_PATH = "//5points_observation_V.glb"
